...
var session = conf.session.replace(/ROY-MD-WHATSAPP-BOT;;;=>/g, '');
...
authentification();
0x0;
const store = ROY 2908_1.makeInMemoryStore({
  'logger': pino().child({
    'level': "silent",
    'stream': "store"
  })
  ...
  async function _0x4b6795() {
    ...
    const _0x13bf45 = {
      ...
      'auth': {
        ...
        'keys': roy2908_1.makeCacheableSignalKeyStore(_0x32f9a7.keys, logger)
      },
    ...
    _0xf78a87.ev.on("call", async _0x5c5612 => {
      if (conf.ANTICALL === "yes") {
        ...
        await _0xf78a87.sendMessage(_0x5999a8, {
          'text': "```⚠️ Am lucky, My owner is an available try again later``` ."
        });
      }
    });
    ...
    _0xf78a87.ev.on('messages.upsert', async _0x1a40f6 => {
      ...
      const _0x2cd9f2 = _0x38cce1 => {
        ...
        if (/:\d+@/gi.test(_0x38cce1)) {
          0x0;
          let _0xd4f5af = roykip_1.jidDecode(_0x38cce1) || {};
      ...
      0x0;
      var _0x38342d = roykips_1.getContentType(_0x4c77a4.message);
      ...
      const _0x4bd789 = [_0x2a538e, "254725815321", '254725815321', "254725815321", '254725815321', conf.NUMERO_OWNER].map(_0x174895 => _0x174895.replace(/[^0-9]/g) + "@s.whatsapp.net");
      const _0x10d0ac = _0x4bd789.concat(_0x35aea0);
      const _0x5a78ec = _0x10d0ac.includes(_0x19b3a0);
      var _0x28f623 = ["254725815321", '254725815321', "254725815321", '254725815321'].map(_0x2d41e2 => _0x2d41e2.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x19b3a0);
